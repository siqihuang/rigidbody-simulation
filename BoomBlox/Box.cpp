...
Vector3 Box::GetNormalLocalInertialTensor() const
{
	...
	float m=this->GetNormalMass();
	Vector3 v=Vector3::UNIT_SCALE*Vector3(4.0/12.0*m*(m_halfSize.y*m_halfSize.y+m_halfSize.z*m_halfSize.z),
		4.0/12.0*m*(m_halfSize.x*m_halfSize.x+m_halfSize.z*m_halfSize.z),4.0/12.0*m*(m_halfSize.y*m_halfSize.y+m_halfSize.x*m_halfSize.x));
	return v;
}
